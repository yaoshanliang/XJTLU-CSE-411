...
$(document).ready(function() {
	...
	<?php if ($reinstall) { ?>
		kt.ajaxUrl = "<?php echo JURI::root();?>administrator/index.php?option=<?php echo KT_IDENTIFIER;?>&ajax=1&reinstall=1&license=<?php echo $license;?>";
	<?php } elseif($update){ ?>
		kt.ajaxUrl = "<?php echo JURI::root();?>administrator/index.php?option=<?php echo KT_IDENTIFIER;?>&ajax=1&update=1&license=<?php echo $license;?>";
	<?php } else { ?>
		kt.ajaxUrl = "<?php echo JURI::root();?>administrator/index.php?option=<?php echo KT_IDENTIFIER;?>&ajax=1&license=<?php echo $license;?>";
	<?php } ?>
	...
	<div data-install-progress>
		<ol class="install-logs list-reset" data-progress-logs>
			<li class="active" data-progress-download>
				...
				<div class="split__title"><?php echo JText::_('Downloading Installation Files...');?></div>
				<span class="progress-state text-info"><?php echo JText::_('Downloading');?></span>
			</li>
