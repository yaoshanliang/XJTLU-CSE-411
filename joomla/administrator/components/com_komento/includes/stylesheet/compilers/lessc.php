...
class KomentoStylesheetLessc
{
	 ...
	 *
	 * See KomentoStylesheetLessc::compileProp()
	 *
	 */
	...
	protected function injectVariables($args) {
		$this->pushEnv();
		$parser = new KomentoStylesheetLessc_parser($this, __METHOD__);
	...
	public function makeParser($name) {
		$parser = new KomentoStylesheetLessc_parser($this, $name);
	...
	protected function newFormatter() {
		$className = "KomentoStylesheetLessc_formatter_lessjs";
		if (!empty($this->formatterName)) {
			if (!is_string($this->formatterName))
				return $this->formatterName;
			$className = "KomentoStylesheetLessc_formatter_$this->formatterName";
		}
...
// syntax tree
class KomentoStylesheetLessc_parser {
	...
	public function __construct($lessc, $sourceName = null) {
		...
		if (!self::$operatorString) {
			self::$operatorString =
				'('.implode('|', array_map(array('KomentoStylesheetLessc', 'preg_quote'),
					array_keys(self::$precedence))).')';

			$commentSingle = KomentoStylesheetLessc::preg_quote(self::$commentSingle);
			$commentMultiLeft = KomentoStylesheetLessc::preg_quote(self::$commentMultiLeft);
			$commentMultiRight = KomentoStylesheetLessc::preg_quote(self::$commentMultiRight);
	 ...
	 *
	 * Consider the function KomentoStylesheetLessc::keyword(). (all parse functions are
	 * structured the same)
	 *
	 ...
	 *
	 * All of these parse functions are powered by KomentoStylesheetLessc::match(), which behaves
	 ...
	 * avoid this, KomentoStylesheetLessc::seek() is used to remember and set buffer positions.
	 *
	...
	protected function isDirective($dirname, $directives) {
		...
		$pattern = implode("|",
			array_map(array("KomentoStylesheetLessc", "preg_quote"), $directives));
	...
	protected function expressionList(&$exps) {
		...
		$exps = KomentoStylesheetLessc::compressList($values, ' ');
		return true;
	}
	...
	public function propertyValue(&$value, $keyName = null) {
		...
		$value = KomentoStylesheetLessc::compressList($values, ', ');
		return true;
	}
	...
	protected function openString($end, &$out, $nestingOpen=null, $rejectStrs = null) {
		...
		$stop = array("'", '"', "@{", $end);
		$stop = array_map(array("KomentoStylesheetLessc", "preg_quote"), $stop);
	...
	protected function string(&$out) {
		...
		$patt = '([^\n]*?)(@\{|\\\\|' .
			KomentoStylesheetLessc::preg_quote($delim).')';
	...
	protected function literal($what, $eatWhitespace = null) {
		...
		if (!isset(self::$literalCache[$what])) {
			self::$literalCache[$what] = KomentoStylesheetLessc::preg_quote($what);
		}
	...
	protected function to($what, &$out, $until = false, $allowNewline = false) {
		...
		if (!$this->match('('.$validChars.'*?)'.KomentoStylesheetLessc::preg_quote($what), $m, !$until)) return false;
...
class KomentoStylesheetLessc_formatter_classic {
	public $indentChar = "  ";
...
class KomentoStylesheetLessc_formatter_compressed extends KomentoStylesheetLessc_formatter_classic {
...
class KomentoStylesheetLessc_formatter_lessjs extends KomentoStylesheetLessc_formatter_classic {
	public $disableSingle = true;
