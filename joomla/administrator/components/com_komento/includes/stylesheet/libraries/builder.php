...
class KomentoStylesheetBuilder 
{
	...
	public function run($preset='cache', $options=array())
	{
		...
		$this->task = new KomentoStylesheetTask("Building $location stylesheet '$name' using '$preset' preset.");
		$task = $this->task;
	...
	{
		$task = new KomentoStylesheetTask("Compiling all sections for group '$group'.");
	...
	{
		$task = new KomentoStylesheetTask("Minifying all sections for group '$group'.");
	...
	{
		$task = new KomentoStylesheetTask("Building group '$group'.");
	...
	public function writeTarget($group, $type, $mode)
	{
		...
		$task = new KomentoStylesheetTask("Writing $type target for '$group'.");
	...
	public function generateIndex($sections=array(), $type='css')
	{
		...
		$task = new KomentoStylesheetTask("Generating index for $type sections.");
	...
	{
		$task = new KomentoStylesheetTask("Joining $type sections.");
