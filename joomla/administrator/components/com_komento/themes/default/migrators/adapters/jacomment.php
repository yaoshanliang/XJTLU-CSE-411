        ...
        <div class="panel">
			...
			<div class="panel-body">
	            <div class="form-group">
		            ...
		            <div class="col-md-7">
						<?php  echo $this->html('grid.selectList', 'components', 'all', KT::migrator()->getAdapter('jacomment')->getComponentSelection(), '', 'data-jacomment-components'); ?>
		            </div>
		        </div>
				...
				<div style="padding-top:20px;">
					<a href="javascript:void(0);" class="btn btn-primary btn-sm" data-migrate-jacomment><?php echo JText::_('COM_KOMENTO_MIGRATORS_RUN_NOW'); ?></a>
				</div>
			</div>
        </div>
    </div>
...
<input type="hidden" name="layout" value="jacomment" />
