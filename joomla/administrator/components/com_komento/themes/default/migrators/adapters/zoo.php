			...
			<div class="panel-body">
	            <div class="form-group">
		            <label for="page_title" class="col-md-5">
		                <?php echo JText::_('COM_KOMENTO_MIGRATORS_ZOO_SELECT_CATEGORIES'); ?>

		                <i data-html="true" data-placement="top" data-title="<?php echo JText::_('COM_KOMENTO_MIGRATORS_ZOO_SELECT_CATEGORIES'); ?>"
		                    data-content="<?php echo JText::_('COM_KOMENTO_MIGRATORS_ZOO_SELECT_CATEGORIES_DESC');?>" data-kt-provide="popover" class="fa fa-question-circle pull-right"></i>
		            </label>

		            <div class="col-md-7">
						<?php  echo $this->html('grid.selectList', 'category', 'all', $categories, '', 'data-zoo-category'); ?>
		            </div>
		        </div>
				...
				<div style="padding-top:20px;">
					<a href="javascript:void(0);" class="btn btn-primary btn-sm" data-migrate-zoo><?php echo JText::_('COM_KOMENTO_MIGRATORS_RUN_NOW'); ?></a>
				</div>
			</div>
        </div>
    </div>
