CREATE TABLE IF NOT EXISTS `#__jwpagefactory` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `asset_id` int(11) NOT NULL,
  `title` varchar(255) NOT NULL,
  `text` mediumtext NOT NULL,
  `extension` varchar(255) NOT NULL DEFAULT 'com_jwpagefactory',
...
CREATE TABLE IF NOT EXISTS `#__jwpagefactory_addons` (
...
CREATE TABLE IF NOT EXISTS `#__jwpagefactory_integrations` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__jwpagefactory_languages` (
  `id` INT(5) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
  `description` mediumtext NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__jwpagefactory_media` (
  `id` bigint(20) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `#__jwpagefactory_sections` (
  `id` INT(5) unsigned NOT NULL AUTO_INCREMENT,
  `title` varchar(255) NOT NULL,
