...
JwAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'jw_articles',
		'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES'),
		'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_DESC'),
		'category' => 'Content',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'tagids' => array(
					'type' => 'select',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_TAGS'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_TAGS_DESC'),
					'depends' => array('resource' => 'article'),
					'values' => JwPageFactoryBase::getArticleTags(),
					'multiple' => true,
				),
				...
				'link_articles' => array(
					'type' => 'checkbox',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_ALL_ARTICLES_BUTTON'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_ALL_ARTICLES_BUTTON_DESC'),
					'values' => array(
						1 => JText::_('COM_JWPAGEFACTORY_YES'),
						0 => JText::_('COM_JWPAGEFACTORY_NO'),
					),
			...
			'options' => array(
				...
				'hide_thumbnail' => array(
					'type' => 'checkbox',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_HIDE_THUMBNAIL'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_HIDE_THUMBNAIL_DESC'),
					'values' => array(
						1 => JText::_('COM_JWPAGEFACTORY_YES'),
						0 => JText::_('COM_JWPAGEFACTORY_NO'),
					),
				...
				'show_author' => array(
					'type' => 'checkbox',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_SHOW_AUTHOR'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_SHOW_AUTHOR_DESC'),
					'values' => array(
						1 => JText::_('COM_JWPAGEFACTORY_YES'),
						0 => JText::_('COM_JWPAGEFACTORY_NO'),
					),
				...
				'show_category' => array(
					'type' => 'checkbox',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_SHOW_CATEGORY'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_SHOW_CATEGORY_DESC'),
					'values' => array(
						1 => JText::_('COM_JWPAGEFACTORY_YES'),
						0 => JText::_('COM_JWPAGEFACTORY_NO'),
					),
				...
				'show_date' => array(
					'type' => 'checkbox',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_SHOW_DATE'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_SHOW_DATE_DESC'),
					'values' => array(
						1 => JText::_('COM_JWPAGEFACTORY_YES'),
						0 => JText::_('COM_JWPAGEFACTORY_NO'),
					),
				...
				'show_readmore' => array(
					'type' => 'checkbox',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_SHOW_READMORE'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_SHOW_READMORE_DESC'),
					'values' => array(
						1 => JText::_('COM_JWPAGEFACTORY_YES'),
						0 => JText::_('COM_JWPAGEFACTORY_NO'),
					),
				...
				'readmore_text' => array(
					'type' => 'text',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_READMORE_TEXT'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ARTICLES_READMORE_TEXT_DESC'),
					'std' => 'Read More',
