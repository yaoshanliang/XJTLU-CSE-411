...
JwAddonsConfig::addonConfig(
	array(
		'type' => 'general',
		'addon_name' => 'jw_button_group',
		'title' => JText::_('COM_JWPAGEFACTORY_ADDON_BUTTON_GROUP'),
		'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_BUTTON_GROUP_DESC'),
		'category' => 'Content',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				// Repeatable Items
				'jw_button_group_item' => array(
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_BUTTONS_ITEM'),
					'attr' => array(
						'title' => array(
							'type' => 'text',
