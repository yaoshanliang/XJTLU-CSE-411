...
JwAddonsConfig::addonConfig(
	array(
		...
		'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION'),
		'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_DESC'),
		'category' => 'Content',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'style' => array(
					'type' => 'select',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_STYLE'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_STYLE_DESC'),
					'values' => array(
						'panel-modern' => JText::_('COM_JWPAGEFACTORY_GLOBAL_MODERN'),
						'panel-default' => JText::_('COM_JWPAGEFACTORY_GLOBAL_DEFAULT'),
						'panel-primary' => JText::_('COM_JWPAGEFACTORY_GLOBAL_PRIMARY'),
						'panel-success' => JText::_('COM_JWPAGEFACTORY_GLOBAL_SUCCESS'),
						'panel-info' => JText::_('COM_JWPAGEFACTORY_GLOBAL_INFO'),
						'panel-warning' => JText::_('COM_JWPAGEFACTORY_GLOBAL_WARNING'),
						'panel-danger' => JText::_('COM_JWPAGEFACTORY_GLOBAL_DANGER'),
						'panel-faq' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_STYLE_FAQ'),
						'panel-custom' => JText::_('COM_JWPAGEFACTORY_GLOBAL_CUSTOM'),
					),
					'std' => 'panel-modern'
				),
				...
				'openitem' => array(
					'type' => 'select',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_OPEN_ITEM'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_OPEN_ITEM_DESC'),
					'values' => array(
						'' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_OPEN_FIRST_ITEM'),
						'show' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_OPEN_ALL_ITEM'),
						'hide' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_CLOSE_ALL_ITEM'),
					),
					'std' => ''
				),
				...
				// Repeatable Item
				'jw_accordion_item' => array(
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ITEMS'),
					'attr' => array(
						'title' => array(
							'type' => 'text',
							'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_TITLE'),
							'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_TITLE_DESC'),
							'std' => 'Accordion Title',
						),
						'icon' => array(
							'type' => 'icon',
							'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ICON'),
							'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ICON_DESC'),
							'std' => ''
						),
						'content' => array(
							'type' => 'builder',
							'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_CONTENT'),
							'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_CONTENT_DESC'),
				...
				'item_separator' => array(
					'type' => 'separator',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ITEM_STYLE_OPTIONS'),
					'depends' => array(
				...
				'item_margin' => array(
					'type' => 'margin',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ITEM_MARGIN'),
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
					'responsive' => true,
				...
				'item_border_color' => array(
					'type' => 'color',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ITEM_BORDER_COLOR'),
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
				),
				...
				'item_border_width' => array(
					'type' => 'margin',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ITEM_BORDER_WIDTH'),
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
				),
				...
				'title_separator' => array(
					'type' => 'separator',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_TITLE_STYLE_OPTION'),
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
				),
				...
				'item_title_bg_color' => array(
					'type' => 'color',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ITEM_TITLE_BG_COLOR'),
					'std' => '',
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
				...
				'item_title_lineheight' => array(
					'type' => 'slider',
					'title' => JText::_('COM_JWPAGEFACTORY_GLOBAL_TITLE_LINE_HEIGHT'),
					'std' => '',
					'responsive' => true,
					'max' => 400,
					'depends' => array(
				...
				'item_title_font_family' => array(
					...
					'selector' => array(
						'type' => 'font',
						'font' => '{{ VALUE }}',
						'css' => '.jwpf-panel-heading { font-family: "{{ VALUE }}"; }'
					),
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
				...
				'icon_separator' => array(
					'type' => 'separator',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ICON_STYLE_OPTIONS'),
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
				),
				...
				'item_content_padding' => array(
					'type' => 'padding',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ITEM_CONTENT_PADDING'),
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
					'responsive' => true,
				...
				'item_content_border_color' => array(
					'type' => 'color',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ITEM_CONTENT_BORDER_COLOR'),
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
				),
				...
				'item_content_border_width' => array(
					'type' => 'margin',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ITEM_CONTENT_BORDER'),
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
				),
				...
				'active_separator' => array(
					'type' => 'separator',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ACTIVE_STYLE_OPTIONS'),
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
				),
				...
				'active_title_bg_color' => array(
					'type' => 'color',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ITEM_ACTIVE_TITLE_BG_COLOR'),
					'std' => '',
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
				...
				'active_title_text_color' => array(
					'type' => 'color',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ACTIVE_TITLE_TEXT_COLOR'),
					'std' => '',
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
				...
				'active_icon_color' => array(
					'type' => 'color',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ACTIVE_ICON_COLOR'),
					'depends' => array(
						array('style', '=', 'panel-custom'),
					),
				),
				...
				'active_icon_rotate' => array(
					'type' => 'slider',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ACCORDION_ICON_ROTATION'),
					'max' => 360,
					'std' => 0,
					'depends' => array(
						array('style', '=', 'panel-custom'),
