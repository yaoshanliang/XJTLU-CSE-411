...
JwAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'alert',
		'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ALERT'),
		'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ALERT_DESC'),
		'category' => 'Content',
		'attr' => array(
			'general' => array(
				'admin_label' => array(
				...
				'text' => array(
					'type' => 'editor',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ALERT_TEXT'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ALERT_TEXT_DESC'),
				...
				'close' => array(
					'type' => 'checkbox',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ALERT_CLOSE_BUTTON'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ALERT_CLOSE_BUTTON_DESC'),
					'std' => 1
				),

				'alrt_type' => array(
					'type' => 'select',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_ALERT_TYPE'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_ALERT_TYPE_DESC'),
					'values' => array(
						...
						'light' => JText::_('COM_JWPAGEFACTORY_GLOBAL_LIGHT'),
