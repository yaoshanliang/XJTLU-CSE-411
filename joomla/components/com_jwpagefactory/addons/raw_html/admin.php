...
JwAddonsConfig::addonConfig(
	array(
		'type' => 'content',
		'addon_name' => 'jw_raw_html',
		'title' => JText::_('COM_JWPAGEFACTORY_ADDON_RAW_HTML'),
		'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_RAW_HTML_DESC'),
		'category' => 'General',
		'attr' => array(
			'general' => array(
				...
				'html' => array(
					'type' => 'textarea',
					'title' => JText::_('COM_JWPAGEFACTORY_ADDON_RAW_HTML_HTML'),
					'desc' => JText::_('COM_JWPAGEFACTORY_ADDON_RAW_HTML_HTML_DESC'),
					'std' => '<p>Insert raw html hrere.<br/>Here is an example of hyper link <a href="http://www.joomla.work">JoomWorker</a></p>',
				),
