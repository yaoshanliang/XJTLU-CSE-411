bbcodeSettings = {
		previewParserPath:	'',
		markupSet: [{className: 'boldbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_BOLD'),key: 'B',openWith: '[b]',closeWith: '[/b]'},{className: 'italicbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_ITALIC'),key: 'I',openWith: '[i]',closeWith: '[/i]'},{className: 'underlinebutton',name: Joomla.JText._('COM_KUNENA_EDITOR_UNDERL'),key: 'U',openWith: '[u]',closeWith: '[/u]'},{className: 'strokebutton',name: Joomla.JText._('COM_KUNENA_EDITOR_STRIKE'),openWith: '[strike]',closeWith: '[/strike]'},{className: 'subscriptbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_SUB'),openWith: '[sub]',closeWith: '[/sub]'},{className: 'supscriptbutton',name: Joomla.JText._('COM_KUNENA_EDITOR_SUP'),openWith: '[sup]',closeWith: '[/sup]'},{ className: 'sizebutton', name: Joomla.JText._('COM_KUNENA_EDITOR_FONTSIZE_SELECTION'),
					...
					},{separator:'|' },{className: 'ebaybutton',name: Joomla.JText._('COM_KUNENA_EDITOR_EBAY'),key: 'E',openWith: '[ebay]',closeWith: '[/ebay]'},{ name: Joomla.JText._('COM_KUNENA_EDITOR_VIDEO'), className: 'videodropdownbutton', dropMenu: [
						{ name: Joomla.JText._('COM_KUNENA_EDITOR_VIDEO_PROVIDER'), className: 'videourlprovider', beforeInsert:function() {
